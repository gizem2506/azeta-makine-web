                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="top-bar-left-wrapper">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#"><i className="zmdi zmdi-linkedin-box" /></a></li>
                                </ul>
                                </div>
                            </div>
                            </div>
                            ...
                            <div className="top-bar-right-wrapper">
                                <a href={`${process.env.PUBLIC_URL}/contact-us`} className="ht-btn ht-btn--default d-inline-block">İletişime Geçin</a>
                            </div>
                            </div>
                        </div>
                        </div>
                                ...
                                <div className="header-info-wrapper align-items-center">
                                    ...
                                    <div className="logo">
                                        <Link to = {`${process.env.PUBLIC_URL}/home-one`}>
                                            <img src="assets/img/logo/logo2.png" className="img-fluid" alt="Logo" />
                                        </Link>
                                    </div>
                                    {/* header contact info */}
                                    ...
                                    <div className="header-navigation header-navigation--header-default position-relative">
                                        ...
                                        <nav>
                                            ...
                                            <li className=" has-children--multilevel-submenu">
                                                <Link to={`${process.env.PUBLIC_URL}/home-one`}> ANASAYFA </Link>
                                             
                                            </li>
                                            <li><Link to={`${process.env.PUBLIC_URL}/about-us`}>HAKKIMIZDA</Link></li>
                                            <li className=" has-children--multilevel-submenu">
                                                <Link to={`${process.env.PUBLIC_URL}/services`}>HİZMETLERİMİZ</Link>
                                            ...
                                            <li><Link to={`${process.env.PUBLIC_URL}/contact-us`}>İLETİŞİM</Link> </li>
                                            </ul>
                                        </nav>
                                        </div>
                                    </div>
